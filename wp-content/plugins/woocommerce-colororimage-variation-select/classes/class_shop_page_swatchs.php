...
class wcva_shop_page_swatches {
	...
	public function wcva_variable_swatches_template($values,$name,$pid,$display_shape,$main_display_type,$swatch_count ) { 
        ...
        ?>
	<div class="shopswatchinput <?php echo $sliderclass; ?> ">
	    <?php  
        ...
        //if (isset($load_assets) && ($load_assets == "yes")) {
	        ...
	        foreach ($values as $key=>$value) { 
		        ...
		        }elseif($custom_size_product_image && (isset($product_image_width)) && (isset($product_image_height)) && ($product_image_width !== '') && ($product_image_height !== '')){
