...
<div class="ocdi  wrap  about-wrap">
	...
	<div class="ocdi__intro-text">
		...
		<ul>
			...
			<li style="color: #000; font-size: 18px; line-height: normal;"><?php esc_html_e( 'First you need to import Base Content first. Then, please click on the Import button only once and wait, it can take a couple of minutes.', 'pt-ocdi' ); ?></li>
			<li style="color: #000; font-size: 18px; line-height: normal;">
				<?php esc_html_e( 'Before importing the base content you need to import the slider. Because the theme uses multiple slides, we cannot import sliders automatically. You need to import the slider homepage you want to manually follow the instructions', 'pt-ocdi')?> <a target="_blank" href="http://hn.arrowpress.net/lusion-gui/#2.2.3RevolutionSliderConfiguration"><?php esc_html_e('here', 'pt-ocdi'); ?></a> and you can go to <a target="_blank" href="<?php echo get_site_url(null, 'wp-admin/admin.php?page=revslider'); ?>">link</a> to improt slider
			</li>
		</ul>
