...
function lusion_woocommerce_list_view()
{
    ...
    <div class="list-view">
        <ul class="list-view-as">
            ...
            <li class="four-2">
                <a href="#" class="<?php if($lusion_product_layout =='grid_list') {echo 'active';}?>" id="grid4" data-layout="layout-grid" data-column="<?php echo esc_attr($lusion_product_column);?>"><i class="theme-icon-grid"></i></a>
            </li>
            <li class="list-last" >
                <a href="#" class="<?php if($lusion_product_layout =='list_grid') {echo 'active';}?>" id="list1" data-layout="layout-list" data-column="<?php echo esc_attr($lusion_product_list_column);?>"><i class="theme-icon-list"></i></a>
            </li>
            <?php endif; ?>
        </ul>
    </div>
                ...
                <a class="img-last" href="<?php echo esc_url(get_permalink($product->get_id())); ?>"
                   title="<?php echo esc_attr($product->get_title()); ?>">
                    <img class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail"
                         ...
                         srcset="<?php echo esc_url($last_image_url); ?>" width="<?php echo esc_attr($attachment_size[0]); ?>" height="<?php echo esc_attr($attachment_size[1]); ?>" />
                </a>
            <?php endif; ?>
        <?php endif; ?>
        <?php if ($woocommerce_loop['show_custom_image'] === 'yes') : ?>
            ...
            <a class="<?php echo esc_attr($class_img); ?>" href="<?php echo esc_url(get_permalink($product->get_id())); ?>"
               title="<?php echo esc_attr($product->get_title()); ?>">
                <img class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail"
                     ...
                     width="<?php echo esc_attr($attachment_size[0]); ?>" height="<?php echo esc_attr($attachment_size[1]); ?>" />
            </a>
        <?php endif; ?>
			...
			<?php if((Lusion::setting('custom_size_product_image')) && (isset($product_image_width)) && (isset($product_image_height)) && ($product_image_width !== '') && ($product_image_height !== '')): ?>
				...
				<a class="img-last" href="<?php echo esc_url(get_permalink($product->get_id())); ?>"
				   title="<?php echo esc_attr($product->get_title()); ?>">
					...
					<img class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail"
						 src="<?php echo esc_url($image_url); ?>" alt="<?php echo esc_attr($product->get_title()); ?>"
						 srcset="<?php echo esc_url($image_url); ?>" width="<?php echo esc_attr($product_image_width); ?>" height="<?php echo esc_attr($product_image_height); ?>" />
				</a>
			<?php else: ?>
				<a class="img-last" href="<?php echo esc_url(get_permalink($product->get_id())); ?>"
				   title="<?php echo esc_attr($product->get_title()); ?>">
